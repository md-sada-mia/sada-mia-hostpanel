...
module.exports = {
  ...
  get nginxVhostsDir() { return config.nginxVhostsDir || (isDev ? path.join(__dirname, '../../dev-vhosts') : '/etc/nginx/sites-available/hostpanel'); },
  get fpmPoolsDir() { return config.fpmPoolsDir || (isDev ? path.join(__dirname, '../../dev-fpm-pools') : `/etc/php/${config.phpVersion}/fpm/pool.d`); },
